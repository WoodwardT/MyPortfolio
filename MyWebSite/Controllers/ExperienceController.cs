...
namespace MyPortfolio.Controllers
{
    public class ExperienceController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Location,Duration,description,CreateAt")] Experience experience)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Location,Duration,description,CreateAt")] Experience experience)
        {
            if (id != experience.Id)
            {
                return NotFound();
